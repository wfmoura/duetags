...
function Cart() {
  ...
  const handleCheckout = () => {
    if (!user) {
      ...
      navigate('/login', { state: { from: '/CheckoutPayment' } }); // Redireciona para o login com o estado de retorno
    } else {
      navigate('/CheckoutPayment'); // Redireciona para o checkout se o usuário estiver logado
    }
  };
